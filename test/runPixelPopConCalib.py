...
-C XXX (or --writeCheckerTemplate=XXX) Template cfg.py for PixelPopConCalibChecker
...
def main(argv):
    ...
    try:
        opts, args = getopt.getopt(argv, 'hdf:t:r:c:D:l:a:po:wqC:', 
    ...
    for opt, value in opts:
        if opt in ('-h', '--help'):
            ...
            writeChecker = True
        elif opt in ['-C', '--writeCheckerTemplate']:
